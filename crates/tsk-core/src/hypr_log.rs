...
//!
//! - Log file: `$XDG_RUNTIME_DIR/tsk/hyprctl.log` (override with `TSK_HYPR_LOG_FILE`)
//! - Disable with `TSK_HYPR_LOG=0`
//! - Inspect: `tsk debug hypr log show`
...
pub fn log_path() -> Option<PathBuf> {
    if let Ok(path) = std::env::var("TSK_HYPR_LOG_FILE") {
