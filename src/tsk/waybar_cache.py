"""Fast Waybar module cache — avoids spawning heavy tsk imports on every poll."""
...
def write_modules_cache(
    ...
    if notify:
        from tsk.integrations.waybar_notify import notify_waybar
...
def refresh_modules_cache(*, notify: bool = False) -> bool:
    ...
    from tsk.daemon import context_sync
    from tsk.daemon.service import TaskService
    from tsk.daemon.waybar_export import build_all_modules
