...
from tsk.core.models import SessionState
from tsk.core.taskspaces import visible_default_workspace_count
from tsk.daemon import context_sync, workspace_nav
...
def write_waybar_file(state: SessionState) -> None:
    try:
        ...
        xdg.tsk_waybar_file().write_text(json.dumps(data) + "\n")
        from tsk.waybar_cache import write_modules_cache
